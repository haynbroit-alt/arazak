---
name: post-mortem
description: Post-mortem de fin de projet LASTO — fonctionné/échoué/à changer, leçons transformées en règles. Utiliser quand un projet se termine ou que l'utilisateur dit "post-mortem [projet]".
---

# Post-mortem projet

1. Rassembler : entrées JOURNAL.md et DECISIONS.md liées au projet,
   historique GitHub si repo associé (durée réelle, reprises).
2. Produire le bilan :
